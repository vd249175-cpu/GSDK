...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: '@graphvideo/sdk/node', replacement: resolve(here, '../../packages/sdk/javascript/src/node/index.ts') },
      { find: /^@graphvideo\/workbench\/(.*)$/, replacement: `${resolve(here, '../../packages/frontend/workbench/src')}/$1` },
      { find: '@graphvideo/workbench', replacement: resolve(here, '../../packages/frontend/workbench/src/index.ts') },
      ...
      { find: '@graphvideo/sdk/tokens', replacement: resolve(here, '../../packages/frontend/tokens/index.ts') },
