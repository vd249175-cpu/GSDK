...
import type { RecentLocalProject } from '../client-sdk'
...
import { applicationDefinition } from 'virtual:graphvideo-config'
import { isThemeName, readThemePreference } from '@graphvideo/workbench'

function readInitialTheme(): ThemeName {
  return readThemePreference(isThemeName(applicationDefinition.defaultTheme) ? applicationDefinition.defaultTheme : 'dark')
}
