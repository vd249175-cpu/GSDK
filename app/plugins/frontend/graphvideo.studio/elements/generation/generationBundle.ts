import { type NodeVersion, type ProjectNode, type ProjectTreeItem } from '../../frontend/client-sdk'
import { orderedGenerationReferenceIds } from '../../backend/shared/generation-reference-order.mjs'
