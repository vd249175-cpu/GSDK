...
import {
  ...
  type LaunchpadItem,
  type ExecutionMode,
} from '../../backend/domain/launchpad-scheduler'
import {
...
export function useLaunchpadPipeline() {
  ...
  function buildNodeReferences(item: LaunchpadItem): import('../../frontend/application/contract/domain').GenerationModelReference[] {
