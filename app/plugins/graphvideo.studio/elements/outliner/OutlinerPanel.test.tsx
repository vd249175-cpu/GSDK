...
import type { PanelProps, ProjectNode, ProjectTreeItem } from '../../frontend/client-sdk'
...
vi.mock('../../frontend/client-sdk', async (importOriginal) => {
  const original = await importOriginal<typeof import('../../frontend/client-sdk')>()
