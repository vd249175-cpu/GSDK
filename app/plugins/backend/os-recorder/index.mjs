...
export const CONTROL_ADAPTER_ID = 'ufo/psr-capture-control'
export const OBSERVATION_ADAPTER_ID = 'ufo/psr-capture-observation'
export const EVENTS_ADAPTER_ID = 'ufo/desktop-capture-events'
