...
echo ============================================================
echo   GraphFramework · 正在启动 browser-recorder run...
echo ============================================================
...
echo.
echo ============================================================
echo   GraphFramework · browser-recorder 运行已就绪
echo   --------------------------------------------------------
echo   - 权威微内核与浏览器录制宿主正在运行中
...
echo.
echo 正在停止 browser-recorder 并释放资源...
"%BASH_CMD%" "%REPO_ROOT%\run.sh" stop "%RUN_DIR%\run.config.json"
echo browser-recorder 已成功停机。
exit /b 0
