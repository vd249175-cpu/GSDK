      ...
      <div className="stats-group">
        <div className="stat-item">
          ...
          <div className="tier-counters">
            <span className="tier-pill domain" title="纯领域聚落海岛 (Zero I/O)">
              ◈ 领域 {domainCount}
            </span>
            <span className="tier-pill obs" title="观察悬崖灯塔海岛 (零主动写，只感知物理世界)">
              ▲ 观察 {obsCount}
            </span>
            <span className="tier-pill exec" title="执行垂钓渔港海岛 (下发动作，结算即离)">
              ▼ 执行 {execCount}
            </span>
          </div>
        </div>
