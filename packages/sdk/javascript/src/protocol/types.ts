...
export interface ChangeRecord {
  ...
  readonly stateDeltas?: import('../node/observation').StateDelta[];
...
export interface WorldChangeContext<S = any> extends DomainChangeContext<S> {
  effectAdapter<Request, Observation>(
    adapter: import('../effect/effects').EffectAdapter<Request, Observation>,
    request: Request,
...
export interface Probe {
  onTraceEvent?(event: import('../node/observation').TraceEvent): void;
