...
import { nodeRuntimeCapability } from '../testing/internal-access';
 ...
 * Production systems must run on the native Rust scheduler via `@graphframework/sdk/node`'s `NativeRuleSpace`.
