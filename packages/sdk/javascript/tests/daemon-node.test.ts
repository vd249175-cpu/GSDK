...
class FixtureClient implements DaemonNodeWorkerClient {
  ...
  async requestEffect(): Promise<{ effectId: number }> { throw new Error('no fixture EffectAdapter'); }
  async awaitEffect(): Promise<{ ok: boolean; value: unknown } | null> { return null; }
