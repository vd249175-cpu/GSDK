...
import { buildCausalIndexFromSnapshot, buildAllNodesView, findCausalPaths, validateCausalIndex } from '../src/analysis/portable';
import type { PortableAnalysisSnapshot } from '../src/analysis/model';
