...
describe('application assembly', () => {
  it('loads the repository application with plugin-owned host and renderer', () => {
    ...
    expect(app.hostEntry).toBe(resolve(app.directory, 'plugins/graphvideo.studio/desktop/main.mjs'))
    expect(app.rendererEntry).toBe(resolve(app.directory, 'plugins/graphvideo.studio/frontend/main.tsx'))
  })
