...
export default defineConfig({
  ...
  test: {
    include: ['packages/desktop/application.test.mjs', 'packages/desktop/host/**/*.test.{mjs,ts}', 'app/plugins/*/{backend,frontend,elements,desktop,tests,resources}/**/*.test.{mjs,ts,tsx}', 'app/plugins/*/*/{backend,frontend,elements,desktop,tests,resources}/**/*.test.{mjs,ts,tsx}', 'app/plugins/*/backend.test.mjs', 'packages/frontend/*/{src,styles}/**/*.test.{ts,tsx}', 'runs/main/tests/**/*.test.{mjs,ts}'],
